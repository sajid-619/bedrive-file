...
import { u as useSettings, C as CustomMenu, T as Trans, m as message, a as apiClient, b as useIsMobileMediaQuery, c as useNumberFormatter, S as SelectForwardRef, I as Item, d as IconButton, e as createSvgIcon, K as KeyboardArrowDownIcon, f as useDialogContext, D as Dialog, g as DialogHeader, h as DialogBody, F as Form$1, i as Checkbox, B as Button, j as DialogTrigger, k as useTrans, l as TextField, n as SearchIcon, o as opacityAnimation, p as Skeleton, P as ProgressBar, q as StaticPageTitle, r as queryClient, t as toast, s as showHttpErrorToast, v as ConfirmationDialog, w as IllustratedMessage, x as SvgImage, y as DialogFooter, z as onFormQueryError, A as FormTextField, E as CheckIcon, G as CloseIcon, H as Chip, J as FormattedDate, L as Tooltip, M as getInputFieldClassNames, N as clamp, O as createEventHandler, Q as ButtonBase, R as FormImageSelector, U as useValueLists, V as DoneAllIcon, W as List, X as ListItem, Y as createSvgIconFromTree, Z as FormSelect, _ as Section, $ as MixedText, a0 as FileUploadProvider, a1 as useAppearanceEditorMode, a2 as ProgressCircle, a3 as useNavigate$1, a4 as useBootstrapData, a5 as FullPageLoader, a6 as LinkStyle, a7 as SiteConfigContext, a8 as ExternalLink, a9 as MenuTrigger, aa as Menu, ab as FormRadioGroup, ac as FormRadio, ad as DateFormatPresets, ae as prettyBytes, af as useSocialLogin, ag as useField, ah as Field, ai as useResendVerificationEmail, aj as useUser, ak as useUploadAvatar, al as useRemoveAvatar, am as FileTypeIcon, an as useProducts, ao as FormattedPrice, ap as useActiveUpload, aq as UploadInputType, ar as Disk, as as WarningIcon, at as useCustomPage, au as PageMetaTags, av as PageStatus, aw as AuthRoute, ax as NotFoundPage } from "../server-entry.mjs";
import { D as DashboardLayout, a as DashboardNavbar, b as DashboardSidenav, c as DashboardContent, F as FilterOperator, d as FilterControlType, e as createdAtFilter, u as updatedAtFilter, A as Avatar, K as KeyboardArrowLeftIcon, f as KeyboardArrowRightIcon, g as useBackendFilterUrlParams, I as InputFilterPanel, N as NormalizedModelFilterPanel, h as DateRangeFilterPanel, C as ChipFieldFilterPanel, S as SelectFilterPanel, B as BackendFiltersUrlKey, i as FilterList$1, T as Table, j as AddIcon, k as downloadFileFromUrl, l as FileDownloadIcon, m as FormDatePicker, n as FormSwitch, o as ChipList, p as usePointerEvents, q as Switch, r as FormChipField, s as useDraggable, t as useDroppable, v as updateRects, w as droppables, x as DeleteIcon, U as USER_MODEL, L as LinkIcon, M as MoreVertIcon, y as ChipField, z as useCurrentDateTime, E as useNormalizedModels, G as FILE_ENTRY_INDEX_FILTERS, H as FilePreviewDialog, J as timestampFilter, O as FormNormalizedModelField, P as UnfoldMoreIcon, Q as ArrowBackIcon } from "./UnfoldMore-a9683c4c.mjs";
...
import { E as EditIcon, B as Breadcrumb, a as BreadcrumbItem } from "./Edit-ce7ae1ac.mjs";
...
import { u as useCancelSubscription, a as useResumeSubscription } from "./use-resume-subscription-78518032.mjs";
...
function useDatatableData(endpoint2, params, options) {
  return useQuery(
    DatatableDataQueryKey(endpoint2, params),
    () => paginate(endpoint2, params),
    {
      ...options,
...
function paginate(endpoint2, params) {
...
function DataTablePaginationFooter({
  ...
  if (!pagination)
    return null;
  const perPageSelect = /* @__PURE__ */ jsx(
    SelectForwardRef,
    {
      minWidth: "min-w-auto",
      ...
      onSelectionChange: (value) => {
        onPerPageChange == null ? void 0 : onPerPageChange(value);
      },
                ...
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex-auto overflow-hidden overflow-ellipsis", children: [
                      ...
                      description && /* @__PURE__ */ jsx("div", { className: "text-muted text-xs", children: description })
                    ] }),
                    chevronPosition === "right" && chevron
                  ]
                }
              ),
              endAppend && /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 text-sm text-muted px-4", children: endAppend })
            ]
          }
        ),
        /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              (query.isFetched || query.isPreviousData) && !(pagination == null ? void 0 : pagination.data.length) ? /* @__PURE__ */ jsx("div", { className: "pt-50", children: cloneElement(emptyStateMessage, {
                isFiltering
              }) }) : void 0,
              /* @__PURE__ */ jsx(
...
function useDeleteSelectedRows() {
  ...
  return useMutation(() => deleteSelectedRows(endpoint2, selectedRows), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(DatatableDataQueryKey(endpoint2));
      toast(
...
function DeleteItemsDialog() {
  ...
  return /* @__PURE__ */ jsx(
    ConfirmationDialog,
    {
      isLoading: deleteSelectedRows2.isLoading,
      title: /* @__PURE__ */ jsx(
        Trans,
        {
...
function useExportCsv(endpoint2) {
  return useMutation(
    (payload) => exportCsv(endpoint2, payload),
    {
...
function useBanUser(form, userId) {
  return useMutation((payload) => banUser(userId, payload), {
    onSuccess: () => {
...
const columnConfig$6 = [
  ...
  },
  {
    ...
    body: (user) => {
      var _a2;
      return ((_a2 = user.subscriptions) == null ? void 0 : _a2.length) ? /* @__PURE__ */ jsx(CheckIcon, { className: "icon-md text-positive" }) : /* @__PURE__ */ jsx(CloseIcon, { className: "icon-md text-danger" });
    }
  },
  {
    key: "roles",
    header: () => /* @__PURE__ */ jsx(Trans, { message: "Roles" }),
    body: (user) => /* @__PURE__ */ jsx(ChipList, { radius: "rounded", size: "xs", children: user.roles.map((role) => /* @__PURE__ */ jsx(Chip, { selectable: true, children: /* @__PURE__ */ jsx(
      Link,
      {
...
function UserIndex() {
  ...
  const filteredColumns = !billing.enable ? columnConfig$6.filter((c) => c.key !== "subscribed") : columnConfig$6;
...
const IconList = React.lazy(() => import("./icon-list-61fe3c85.mjs"));
...
function useSaveAppearanceChanges() {
  return useMutation(
    (values) => saveAppearanceChanges(values),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(["admin/appearance/values"]);
...
function AppearanceForm({ defaultValues }) {
  ...
  return /* @__PURE__ */ jsxs(
    Form$1,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Header$2, { isLoading: saveChanges.isLoading }),
...
const AceEditor = React.lazy(() => import("./ace-editor-bd1e907e.mjs"));
function AceDialog({
  defaultValue,
  mode = "html",
  title,
...
function useUpdateSeoTags(name) {
  ...
  return useMutation(
    (payload) => updateTags(name, payload.tags),
    {
      onSuccess: async () => {
        await queryClient2.invalidateQueries(["admin", "seo-tags", name]);
...
function TagsEditorDialog({ name, value }) {
  ...
  return /* @__PURE__ */ jsx(
    AceDialog,
    {
      ...
      isSaving: updateTags2.isLoading,
      beautify: false,
      onSave: (newValue) => {
        if (newValue != null) {
          updateTags2.mutate(
...
function FormWrapper({ children, defaultValues }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    updateSettings.isLoading && /* @__PURE__ */ jsx(
      ProgressBar,
      {
        size: "xs",
...
function useGenerateDropboxRefreshToken() {
  return useMutation((props) => generateToken(props), {
    onError: (err) => showHttpErrorToast(err)
  });
}
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(
      Button,
      {
        ...
        disabled: !s3DriverEnabled || uploadCors2.isLoading,
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            size: "xs",
            color: "primary",
            disabled: clearCache2.isLoading,
            onClick: () => {
              clearCache2.mutate();
            },
...
function useUpdateUser(form) {
  const navigate = useNavigate$1();
  return useMutation((props) => updateUser(props), {
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  backButton,
                  /* @__PURE__ */ jsx("h1", { className: "text-xl md:text-3xl whitespace-nowrap overflow-hidden overflow-ellipsis md:mr-64", children: title }),
...
function CrupdateUserForm({
  ...
  return /* @__PURE__ */ jsxs(
    CrupdateResourceLayout,
    {
      ...
      isLoading,
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-40 md:gap-80 mb-40", children: [
          avatarManager,
        ...
        /* @__PURE__ */ jsxs("div", { className: "border-t border-b mb-30 pb-30 pt-30", children: [
          /* @__PURE__ */ jsx(
            FormSwitch,
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-30 pt-30 border-t", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm mb-10", children: /* @__PURE__ */ jsx(Trans, { message: "Permissions" }) }),
...
function UpdateUserPage() {
  ...
  const resendEmailButton = /* @__PURE__ */ jsx(
    Button,
    {
      ...
      variant: "outline",
      color: "primary",
      disabled: !require_email_confirmation || resendConfirmationEmail.isLoading || ((_a2 = data == null ? void 0 : data.user) == null ? void 0 : _a2.email_verified_at) != null,
      onClick: () => {
  ...
  return /* @__PURE__ */ jsx(
    CrupdateUserForm,
    {
      ...
      isLoading: updateUser2.isLoading,
...
function useCreateUser(form) {
  const navigate = useNavigate$1();
  return useMutation((props) => createUser(props), {
    onSuccess: () => {
...
function CreateUserPage() {
  ...
  return /* @__PURE__ */ jsxs(
    CrupdateUserForm,
    {
      ...
      isLoading: createUser2.isLoading,
      avatarManager,
      children: [
        /* @__PURE__ */ jsx(
          FormTextField,
...
function useUpdateLocalization(form) {
  return useMutation(
    (props) => UpdateLocalization(props),
    {
      onSuccess: () => {
...
function useCreateLocalization(form) {
  const queryClient2 = useQueryClient();
  return useMutation(
    (props) => createLocalization(props),
    {
      onSuccess: () => {
        toast(message("Localization created"));
        queryClient2.invalidateQueries(DatatableDataQueryKey("localizations"));
      },
      onError: (r) => onFormQueryError(r, form)
    }
  );
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          type: "submit",
          form: formId,
          disabled: createLocalization2.isLoading,
          children: /* @__PURE__ */ jsx(Trans, { message: "Save" })
        }
      )
    ] })
...
function useRole() {
  ...
  return useQuery([Endpoint$4(roleId)], () => fetchRole(roleId));
}
const Endpoint$3 = (id) => `roles/${id}`;
function useUpdateRole() {
  const { trans } = useTrans();
  const navigate = useNavigate$1();
  return useMutation((payload) => updateRole(payload), {
    onSuccess: (response) => {
      toast(trans(message("Role updated")));
      queryClient.invalidateQueries([Endpoint$3(response.role.id)]);
...
function useRemoveUsersFromRole(role) {
  return useMutation(
    ({ userIds }) => removeUsersFromRole({ userIds, roleId: role.id }),
    {
...
function useAddUsersToRole(role) {
  return useMutation(
    ({ userIds }) => addUsersToRole({ userIds, roleId: role.id }),
    {
      onSuccess: (response, payload) => {
        toast(
...
function AssignUserAction({ role }) {
  ...
  return /* @__PURE__ */ jsxs(DialogTrigger, { type: "modal", children: [
    /* @__PURE__ */ jsx(Button, { variant: "flat", color: "primary", disabled: addUsers.isLoading, children: /* @__PURE__ */ jsx(Trans, { message: "Assign user" }) }),
    /* @__PURE__ */ jsx(
      SelectUserDialog,
      {
        onUserSelected: (user) => {
...
function RemoveUsersAction({ role }) {
  ...
  return /* @__PURE__ */ jsxs(
    DialogTrigger,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Button, { variant: "flat", color: "danger", disabled: removeUsers.isLoading, children: /* @__PURE__ */ jsx(Trans, { message: "Remove users" }) }),
        /* @__PURE__ */ jsx(
          ConfirmationDialog,
          {
            title: /* @__PURE__ */ jsx(
...
function PageContent$2({ role }) {
  ...
  return /* @__PURE__ */ jsx(
    CrupdateResourceLayout,
    {
      ...
      isLoading: updateRole2.isLoading,
...
function CreateRolePage() {
  ...
  return /* @__PURE__ */ jsx(
    CrupdateResourceLayout,
    {
      ...
      isLoading: createRole2.isLoading,
...
function useCreateNewTag(form) {
  const { trans } = useTrans();
  return useMutation((props) => createNewTag(props), {
    onSuccess: () => {
  ...
  return /* @__PURE__ */ jsxs(Dialog, { children: [
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsx(
        ...
        {
          form: formId,
          disabled: createNewTag2.isLoading,
          variant: "flat",
          color: "primary",
          type: "submit",
          children: /* @__PURE__ */ jsx(Trans, { message: "Save" })
...
function useUpdateTag(form) {
  const { trans } = useTrans();
  return useMutation((props) => updateTag(props), {
    onSuccess: () => {
  ...
  return /* @__PURE__ */ jsxs(Dialog, { size: "md", children: [
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsx(
        ...
        {
          form: formId,
          disabled: updateSubscription2.isLoading,
          variant: "flat",
          color: "primary",
          type: "submit",
          children: /* @__PURE__ */ jsx(Trans, { message: "Save" })
...
function useCreateSubscription(form) {
  const { trans } = useTrans();
  return useMutation((props) => createNewSubscription(props), {
    onSuccess: () => {
      toast(trans(message("Subscription created")));
      queryClient.invalidateQueries(DatatableDataQueryKey(endpoint$3));
    },
    onError: (err) => onFormQueryError(err, form)
  });
}
...
function SuspendSubscriptionButton({ subscription }) {
  ...
  const handleSuspendSubscription = () => {
    cancelSubscription.mutate(
      ...
      {
        onSuccess: () => {
          queryClient.invalidateQueries(DatatableDataQueryKey(endpoint$2));
        }
      }
    );
  };
        ...
        /* @__PURE__ */ jsx(
          ConfirmationDialog,
          {
            ...
            body: /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "font-semibold text-sm mt-10", children: /* @__PURE__ */ jsx(Trans, { message: "This will put user on grace period until their next scheduled renewal date. Subscription can be renewed until that date by user or from admin area." }) })
            ] }),
        ...
        /* @__PURE__ */ jsx(
          ConfirmationDialog,
          {
            ...
            body: /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "font-semibold text-sm mt-10", children: /* @__PURE__ */ jsx(Trans, { message: "This will put user on their original plan and billing cycle." }) })
            ] }),
            confirm: /* @__PURE__ */ jsx(Trans, { message: "Confirm" })
          }
        )
        ...
        /* @__PURE__ */ jsx(
          ConfirmationDialog,
          {
            ...
            body: /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "font-semibold text-sm mt-10", children: /* @__PURE__ */ jsx(Trans, { message: "This will permanently delete the subscription and immediately cancel it on billing gateway. Subscription will not be renewable anymore." }) })
            ] }),
            confirm: /* @__PURE__ */ jsx(Trans, { message: "Confirm" })
          }
        )
...
function useDeleteProduct() {
  const { trans } = useTrans();
  return useMutation((payload) => updateProduct$1(payload), {
    onSuccess: () => {
...
function useProduct() {
  ...
  return useQuery([Endpoint$1(productId)], () => fetchProduct(productId));
}
...
function PageContent$1({ product }) {
  ...
  return /* @__PURE__ */ jsx(
    CrupdateResourceLayout,
    {
      ...
      isLoading: updateProduct2.isLoading,
...
function CreatePlanPage() {
  ...
  return /* @__PURE__ */ jsx(
    CrupdateResourceLayout,
    {
      ...
      isLoading: createProduct2.isLoading,
      children: /* @__PURE__ */ jsx(CrupdatePlanForm, {})
    }
  );
}
...
function useUpdateCustomPage(endpoint2) {
  ...
  return useMutation(
    (payload) => updatePage(payload, finalEndpoint),
    {
      onError: (err) => showHttpErrorToast(err),
      onSuccess: async () => {
        ...
        onSubmit: (value) => {
          if (editor.state.selection.empty && value.text) {
            ...
            if (!value.href) {
              ...
              editor.chain().focus().extendMarkRange("link").setLink({ href: value.href, target: value.target }).run();
            }
          }
          close();
        },
...
const MenubarRowClassName = "flex items-center justify-center px-4 h-42 text-muted border-b overflow-hidden";
function ArticleBodyEditorMenubar({
  ...
  return /* @__PURE__ */ jsxs("div", { className: clsx(extendedVisible ? "h-84" : "h-42"), children: [
    /* @__PURE__ */ jsxs("div", { className: clsx(MenubarRowClassName, "relative z-20"), children: [
      ...
      ) : /* @__PURE__ */ jsx(ExtendedButtons, { editor, size })
    ] }),
...
const ArticleBodyEditor$1 = React.lazy(
  () => import("./article-body-editor-3115132e.mjs")
);
...
function useCreateCustomPage(endpoint2) {
  ...
  return useMutation(
    (payload) => createPage(payload, finalEndpoint),
    {
      onError: (err) => showHttpErrorToast(err),
      onSuccess: async () => {
        await queryClient.invalidateQueries(["custom-pages"]);
...
function CreateCustomPage() {
  ...
  return /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(FullPageLoader, {}), children: /* @__PURE__ */ jsx(ArticleBodyEditor, { children: (content, editor) => /* @__PURE__ */ jsx(FileUploadProvider, { children: /* @__PURE__ */ jsxs(FormProvider, { ...form, children: [
    /* @__PURE__ */ jsx(
      ...
      {
        editor,
        isLoading: createPage2.isLoading,
        onSave: handleSave,
        backLink: "../"
      }
    ),
...
const ReportsPage = React.lazy(() => import("./admin-report-page-0ab8c4a9.mjs"));
...
//# sourceMappingURL=admin-routes-31de440a.mjs.map
