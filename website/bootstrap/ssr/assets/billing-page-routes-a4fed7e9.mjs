...
import { aB as useAuth, aj as useUser, q as StaticPageTitle, T as Trans, aC as Navbar, a2 as ProgressCircle, b8 as Footer, a3 as useNavigate, u as useSettings, B as Button, r as queryClient, m as message, a as apiClient, an as useProducts, b9 as BillingCycleRadio, ba as findBestPrice, o as opacityAnimation, ao as FormattedPrice, E as CheckIcon, p as Skeleton, k as useTrans, t as toast, s as showHttpErrorToast, J as FormattedDate, H as Chip, x as SvgImage, bb as FormattedCurrency } from "../server-entry.mjs";
import { Fragment, useState, useRef, useEffect, createElement } from "react";
import { B as Breadcrumb, a as BreadcrumbItem, E as EditIcon } from "./Edit-ce7ae1ac.mjs";
import { S as StripeElementsForm, B as BillingRedirectMessage } from "./billing-redirect-message-25aaa7cd.mjs";
...
function useChangeSubscriptionPlan() {
  ...
  const navigate = useNavigate();
  return useMutation((props) => changePlan(props), {
    onSuccess: () => {
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
          Button,
          {
            ...
            disabled: changePlan2.isLoading,
...
function CancelledPlanPanel() {
  ...
  return /* @__PURE__ */ jsx(BillingPlanPanel, { title: /* @__PURE__ */ jsx(Trans, { message: "Current plan" }), children: /* @__PURE__ */ jsxs("div", { className: "flex gap-20 justify-between mt-24", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(
        Chip,
        {
      ...
      /* @__PURE__ */ jsx("div", { className: "text-xl font-bold mb-2", children: subscription.product.name }),
      /* @__PURE__ */ jsx(FormattedPrice, { className: "text-xl mb-8", price: subscription.price }),
      /* @__PURE__ */ jsxs("div", { className: "text-base flex items-center gap-8", children: [
...
function ActivePlanPanel() {
  ...
  return /* @__PURE__ */ jsx(BillingPlanPanel, { title: /* @__PURE__ */ jsx(Trans, { message: "Current plan" }), children: /* @__PURE__ */ jsxs("div", { className: "flex gap-20 justify-between mt-24", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "text-xl font-bold mb-2", children: subscription.product.name }),
      /* @__PURE__ */ jsx(FormattedPrice, { className: "text-xl mb-2", price: subscription.price }),
...
//# sourceMappingURL=billing-page-routes-a4fed7e9.mjs.map
