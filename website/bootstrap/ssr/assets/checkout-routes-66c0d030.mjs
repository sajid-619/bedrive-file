...
import { aB as useAuth, bc as removeFromLocalStorage, q as StaticPageTitle, T as Trans, aC as Navbar, C as CustomMenu, bd as LocaleSwitcher, a as apiClient, ao as FormattedPrice, be as ProductFeatureList, bb as FormattedCurrency, o as opacityAnimation, p as Skeleton, an as useProducts, u as useSettings, a5 as FullPageLoader, a4 as useBootstrapData, a3 as useNavigate, m as message } from "../server-entry.mjs";
...
function CheckoutProductSummary({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    status === "loading" ? /* @__PURE__ */ jsx(LoadingSkeleton, {}, "loading-skeleton") : /* @__PURE__ */ jsx(
      ProductSummary,
      {
        product,
        price,
...
//# sourceMappingURL=checkout-routes-66c0d030.mjs.map
