...
function useBackendBootstrapData() {
  return useQuery(queryKey$1, () => fetchBootstrapData(), {
    staleTime: Infinity,
...
function useSvgImageContent(src) {
  return useQuery(
    ["svgImage", getAssetUrl(src)],
    () => fetchSvgImageContent(src),
    {
...
function getSharedButtonStyle(props) {
  ...
  return [
    ...
    whitespace,
    variant && "align-middle inline-flex flex-shrink-0 items-center transition-button duration-200",
...
function useMarkNotificationsAsRead() {
  ...
  return useMutation((props) => UseMarkNotificationsAsRead(props), {
    onSuccess: (response) => {
...
function useJoinWorkspace() {
  ...
  return useMutation((props) => joinWorkspace(props), {
    onSuccess: (response) => {
...
function useDeleteInvite() {
  return useMutation((props) => deleteInvite(props), {
    onSuccess: () => {
      queryClient.invalidateQueries(useUserNotifications.key);
...
const ProgressCircle = React.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: clsx(circleSize, trackColor, "border-4 rounded-full") }),
        /* @__PURE__ */ jsxs(
          "div",
          {
            className: clsx(
...
function useUser(id2, params) {
  return useQuery(queryKey(id2, params), () => fetchUser(id2, params));
}
...
function EmailVerificationPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center p-24 bg-alt w-screen min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-paper px-14 py-28 rounded shadow border max-w-580 flex flex-col items-center text-center", children: [
      /* @__PURE__ */ jsx(SvgImage, { src: mailSentSvg, className: "h-144" }),
      /* @__PURE__ */ jsx("h1", { className: "text-3xl mt-40 mb-20", children: /* @__PURE__ */ jsx(Trans, { message: "Verify your email" }) }),
      ...
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          variant: "flat",
          color: "primary",
          disabled: resendEmail2.isLoading || !(data == null ? void 0 : data.user.email),
          onClick: () => {
...
const Modal = forwardRef(
  ({
    ...
    const viewPortStyle = useOverlayViewport();
    const objRef = useObjectRef(ref);
    return /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 isolate z-modal", style: viewPortStyle, children: [
      /* @__PURE__ */ jsx(
        Underlay,
        {
          onClick: () => {
...
function Listbox({
  ...
  const showContent = children.length > 0 || showEmptyMessage;
...
function FocusContainer({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      ref: domRef,
      ...domProps,
      children: children.length ? children : /* @__PURE__ */ jsx(EmptyMessage, { isLoading })
    }
  );
}
function EmptyMessage({ isLoading }) {
  return /* @__PURE__ */ jsx("div", { className: "px-8 py-4 text-sm italic text-muted", children: isLoading ? /* @__PURE__ */ jsx(Trans, { message: "Loading..." }) : /* @__PURE__ */ jsx(Trans, { message: "There are no items matching your query" }) });
}
...
function extractChildren(rawChildren) {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          ...
          {
            id: labelId,
            className: clsx(titleTextSize, "font-semibold leading-5 opacity-90"),
            children
          }
        ),
        rightAdornment,
...
class LazyLoader {
  ...
  loadStyleAsset(url, id2, resolve) {
    const style = document.createElement("link");
    style.rel = "stylesheet";
    style.id = buildId(url, id2);
    style.href = url;
    style.onload = () => {
  ...
  loadScriptAsset(url, id2, resolve, parentEl) {
    const s = document.createElement("script");
    s.async = true;
    s.id = buildId(url, id2);
    s.src = url;
    s.onload = () => {
      this.loadedAssets[url] = "loaded";
      resolve();
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(
            Button,
            {
              ...
              color: "primary",
              size: "md",
              disabled: register2.isLoading || isVerifying,
...
function Badge({ children, className, withBorder = true }) {
  return /* @__PURE__ */ jsx(
    "span",
    {
      className: clsx(
...
function useValueLists(names, params, options = {}) {
  return useQuery(
    ...
    () => fetchValueLists(names, params),
    {
      ...
      initialData: () => {
        const previousData = queryClient.getQueriesData(["ValueLists"]).find(([, response]) => {
...
function useChangeLocale() {
  ...
  return useMutation((props) => changeLocale(props), {
    onSuccess: (response) => {
      mergeBootstrapData2({
    ...
    MenuTrigger,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(
          Button,
          {
            disabled: changeLocale2.isLoading,
...
function PageStatus({ query, show404 = true, loaderClassName }) {
  const { isLoggedIn } = useAuth();
  if (query.isLoading) {
    return /* @__PURE__ */ jsx(FullPageLoader, { className: loaderClassName });
  }
...
function useTwoFactorChallenge(form) {
  const handleSuccess = useHandleLoginSuccess();
  return useMutation(
    (payload) => completeChallenge(payload),
    {
      onSuccess: (response) => {
        handleSuccess(response);
      },
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(
            Button,
            {
              ...
              color: "primary",
              size: "md",
              disabled: completeChallenge2.isLoading,
...
function SocialLoginPanelRow({
  ...
  const username = (_b = (_a = user == null ? void 0 : user.social_profiles) == null ? void 0 : _a.find(
...
function useUpdateAccountDetails(form) {
  return useMutation((props) => updateAccountDetails(props), {
    onSuccess: () => {
...
function useUploadAvatar({ user }) {
  return useMutation((payload) => UploadAvatar(payload, user), {
    onSuccess: () => {
...
function useDeleteFileEntries() {
  return useMutation((props) => deleteFileEntries(props), {
    onError: (err) => showHttpErrorToast(err)
  });
}
function useActiveUpload() {
  ...
  return {
    ...
    deleteEntry,
    isDeletingEntry: deleteFileEntries2.isLoading,
    activeUpload,
    abortUpload
  };
}
...
function useUpdatePassword(form) {
  return useMutation((props) => updatePassword(props), {
    onSuccess: () => {
    ...
    AccountSettingsPanel,
    {
      ...
      actions: /* @__PURE__ */ jsx(
        Button,
        {
          ...
          variant: "flat",
          color: "primary",
          disabled: !form.formState.isValid || updatePassword2.isLoading,
...
function useDeleteAccessToken() {
  return useMutation((props) => deleteAccessToken(props), {
    onSuccess: () => {
...
function useConfirmPassword(form) {
  return useMutation((payload) => confirm$1(payload), {
    onError: (r2) => onFormQueryError(r2, form)
  });
}
...
function useConfirmTwoFactor(form) {
  return useMutation((payload) => confirm(payload), {
    onError: (r2) => onFormQueryError(r2, form)
  });
}
...
function CodeForm({ onCancel, onConfirmed }) {
  ...
  const { withConfirmedPassword, isLoading: confirmPasswordIsLoading } = usePasswordConfirmedAction();
  const isLoading = confirmTwoFactor.isLoading || disableTwoFactor.isLoading || confirmPasswordIsLoading;
  return /* @__PURE__ */ jsxs(
    Form,
    {
      form,
...
function TwoFactorEnabledStep({ user, onDisabled }) {
  ...
  const { withConfirmedPassword, isLoading: confirmPasswordIsLoading } = usePasswordConfirmedAction();
  const isLoading = disableTwoFactor.isLoading || regenerateCodes.isLoading || confirmPasswordIsLoading;
...
function useLogoutOtherSessions() {
  return useMutation((payload) => logoutOther(payload), {
    onError: (r2) => showHttpErrorToast(r2)
  });
}
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            variant: "outline",
            color: "primary",
            disabled: checkingPasswordStatus || logoutOther2.isLoading,
            onClick: () => {
...
const BillingPageRoutes = React.lazy(
  () => import("./assets/billing-page-routes-a4fed7e9.mjs")
);
const CheckoutRoutes = React.lazy(() => import("./assets/checkout-routes-66c0d030.mjs"));
...
function useUpdateNotificationSettings() {
  return useMutation(
    (payload) => UpdateNotificationSettings(payload),
    {
      onSuccess: () => {
...
function useSubmitContactForm(form) {
  const { trans } = useTrans();
  const navigate = useNavigate();
  return useMutation((props) => submitContactForm(props), {
    onSuccess: () => {
...
const AdminRoutes = React.lazy(() => import("./assets/admin-routes-31de440a.mjs").then((n) => n.y));
const DriveRoutes = React.lazy(() => import("./assets/drive-routes-8c734873.mjs"));
const SwaggerApiDocs = React.lazy(
  () => import("./assets/swagger-api-docs-page-8ba68da3.mjs")
);
function AppRoutes() {
...
export {
  ...
  Tooltip as L,
  getInputFieldClassNames as M,
  clamp as N,
  createEventHandler as O,
  ProgressBar as P,
  ButtonBase as Q,
  ...
  Section as _,
  apiClient as a,
  useDateFormatter as a$,
  FileUploadProvider as a0,
  useAppearanceEditorMode as a1,
  ProgressCircle as a2,
  useNavigate as a3,
  ...
  useAuth as aB,
  Navbar as aC,
  secureFilesSvg as aD,
  getAxiosErrorMessage as aE,
  useFileUploadStore as aF,
  useActiveWorkspaceId as aG,
  UploadedFile as aH,
  openUploadWindow as aI,
  AdHost as aJ,
  ProgressBarBase as aK,
  WorkspaceQueryKeys as aL,
  PersonalWorkspace as aM,
  ExitToAppIcon as aN,
  ArrowDropDownIcon as aO,
  useUserWorkspaces as aP,
  CustomMenuItem as aQ,
  shallowEqual as aR,
  ContextMenu as aS,
  useMediaQuery as aT,
  useActiveWorkspace as aU,
  ErrorIcon as aV,
  CheckCircleIcon as aW,
  ComboBoxForwardRef as aX,
  Underlay as aY,
  useUserTimezone as aZ,
  useSelectedLocale as a_,
  Menu as aa,
  FormRadioGroup as ab,
  FormRadio as ac,
  DateFormatPresets as ad,
  prettyBytes as ae,
  useSocialLogin as af,
  useField as ag,
  Field as ah,
  useResendVerificationEmail as ai,
  useUser as aj,
  useUploadAvatar as ak,
  useRemoveAvatar as al,
  FileTypeIcon as am,
  useProducts as an,
  FormattedPrice as ao,
  useActiveUpload as ap,
  UploadInputType as aq,
  Disk as ar,
  WarningIcon as as,
  useCustomPage as at,
  PageMetaTags as au,
  ...
  AvatarPlaceholderIcon as b0,
  useIsDarkMode as b1,
  useListbox as b2,
  Listbox as b3,
  Popover as b4,
  useListboxKeyboardNavigation as b5,
  useAutoFocus as b6,
  isAbsoluteUrl as b7,
  Footer as b8,
  BillingCycleRadio as b9,
  PaymentsIcon as bA,
  PeopleIcon as bB,
  PersonIcon as bC,
  PhonelinkLockIcon as bD,
  SmartphoneIcon as bE,
  TabletIcon as bF,
  useCollator as bG,
  elementToTree as bH,
  findBestPrice as ba,
  FormattedCurrency as bb,
  removeFromLocalStorage as bc,
  LocaleSwitcher as bd,
  ProductFeatureList as be,
  useThemeSelector as bf,
  lazyLoader as bg,
  AccountCircleIcon as bh,
  AddAPhotoIcon as bi,
  ApiIcon as bj,
  CheckBoxOutlineBlankIcon as bk,
  ComputerIcon as bl,
  DangerousIcon as bm,
  DarkModeIcon as bn,
  DevicesIcon as bo,
