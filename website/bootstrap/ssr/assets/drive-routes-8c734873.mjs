...
import { r as queryClient, ay as getFromLocalStorage, az as setInLocalStorage, aA as getBootstrapData, a as apiClient, s as showHttpErrorToast, m as message, t as toast, aB as useAuth, a9 as MenuTrigger, d as IconButton, K as KeyboardArrowDownIcon, aa as Menu, I as Item, T as Trans, L as Tooltip, B as Button, b as useIsMobileMediaQuery, aC as Navbar$1, am as FileTypeIcon, k as useTrans, x as SvgImage, aD as secureFilesSvg, l as TextField, aE as getAxiosErrorMessage, ae as prettyBytes, aF as useFileUploadStore, aG as useActiveWorkspaceId, u as useSettings, aH as UploadedFile, aI as openUploadWindow, J as FormattedDate, i as Checkbox, a2 as ProgressCircle, aJ as AdHost, o as opacityAnimation, j as DialogTrigger, _ as Section, a0 as FileUploadProvider, w as IllustratedMessage, ax as NotFoundPage, aK as ProgressBarBase, aL as WorkspaceQueryKeys, z as onFormQueryError, f as useDialogContext, D as Dialog, g as DialogHeader, h as DialogBody, F as Form, A as FormTextField, y as DialogFooter, aM as PersonalWorkspace, v as ConfirmationDialog, U as useValueLists, aN as ExitToAppIcon, G as CloseIcon, aO as ArrowDropDownIcon, aP as useUserWorkspaces, Q as ButtonBase, E as CheckIcon, O as createEventHandler, a3 as useNavigate$1, aQ as CustomMenuItem, C as CustomMenu, aR as shallowEqual, n as SearchIcon, aS as ContextMenu, aT as useMediaQuery, aU as useActiveWorkspace, $ as MixedText, aV as ErrorIcon, as as WarningIcon, aW as CheckCircleIcon, a7 as SiteConfigContext, aX as ComboBoxForwardRef, W as List, X as ListItem, q as StaticPageTitle, aw as AuthRoute } from "../server-entry.mjs";
...
import { R as useFileEntryUrls, k as downloadFileFromUrl, l as FileDownloadIcon, V as FileThumbnail, L as LinkIcon, x as DeleteIcon, W as TableContext, M as MoreVertIcon, T as Table, H as FilePreviewDialog, D as DashboardLayout, a as DashboardNavbar, c as DashboardContent, X as FilePreviewContainer, Y as FileEntryUrlsContext, y as ChipField, P as UnfoldMoreIcon, j as AddIcon, t as useDroppable, s as useDraggable, Z as FILE_ENTRY_TYPE_FILTER, F as FilterOperator, d as FilterControlType, e as createdAtFilter, u as updatedAtFilter, _ as DashboardLayoutContext, i as FilterList, w as droppables, p as usePointerEvents, v as updateRects, $ as activeInteraction, a0 as isCtrlOrShiftPressed, a1 as isCtrlKeyPressed, A as Avatar, E as useNormalizedModels, U as USER_MODEL, q as Switch, n as FormSwitch, m as FormDatePicker, Q as ArrowBackIcon, a2 as dragMonitors, b as DashboardSidenav } from "./UnfoldMore-a9683c4c.mjs";
...
import { B as Breadcrumb, a as BreadcrumbItem, E as EditIcon, C as ChevronRightIcon } from "./Edit-ce7ae1ac.mjs";
...
function useShareableLinkPage() {
  ...
  const query = useInfiniteQuery(
    ...
    ({ pageParam = 1 }) => {
      return fetchLinkByHash({ hash, page: pageParam, order, password });
    },
    {
      initialData: () => {
        var _a3;
...
function isPasswordInvalidResponse(e) {
  var _a2, _b2;
  return axios.isAxiosError(e) && ((_b2 = (_a2 = e.response) == null ? void 0 : _a2.data) == null ? void 0 : _b2.passwordInvalid);
}
...
function useCheckLinkPassword() {
  return useMutation((props) => checkLinkPassword(props), {
...
function useImportIntoOwnDrive() {
  const password = useLinkPageStore((s) => s.password);
  return useMutation(
    (props) => importIntoOwnDrive({ ...props, password }),
    {
      onSuccess: async () => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    !alreadyImported && isLoggedIn && link.allow_edit && /* @__PURE__ */ jsxs(
      MenuTrigger,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(IconButton, { className: "ml-6", disabled: importIntoOwnDrive2.isLoading, children: /* @__PURE__ */ jsx(KeyboardArrowDownIcon, {}) }),
...
function ShareableLinkNavbar() {
  ...
  return /* @__PURE__ */ jsx(
    Navbar$1,
    {
      ...
      hideLogo: isMobile,
      children: (link == null ? void 0 : link.entry) && link.entry.type !== "folder" && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-10", children: [
        /* @__PURE__ */ jsx(FileTypeIcon, { className: "flex-shrink-0", type: link.entry.type }),
        /* @__PURE__ */ jsx("div", { className: "font-medium whitespace-nowrap overflow-hidden overflow-ellipsis flex-auto", children: link.entry.name })
      ] })
    }
  );
}
function PasswordPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-alt h-screen flex flex-col", children: [
    /* @__PURE__ */ jsx(ShareableLinkNavbar, {}),
    /* @__PURE__ */ jsx("div", { className: "px-10 md:px-20 mx-auto my-80", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row gap-40 md:gap-14 bg items-center max-w-[560px] border rounded p-24", children: [
      /* @__PURE__ */ jsx("div", { className: "h-132", children: /* @__PURE__ */ jsx(SvgImage, { src: secureFilesSvg }) }),
      /* @__PURE__ */ jsxs(
        "form",
        {
          onSubmit: (e) => {
...
function useCreateShareableLink() {
  return useMutation(({ entryId }) => createShareableLink(entryId), {
...
function useAddStarToEntries() {
  return useMutation((payload) => addStarToEntries(payload), {
...
function useRemoveStarFromEntries() {
  return useMutation((payload) => removeStarFromEntries(payload), {
    onSuccess: (data, { entryIds }) => {
      invalidateEntryQueries();
      toast(
...
function useUnshareEntries() {
  return useMutation((payload) => unshareEntries(payload), {
    onSuccess: () => {
...
function useRestoreEntries() {
  return useMutation((payload) => restoreEntries(payload), {
    onSuccess: (r, p) => {
      invalidateEntryQueries();
      toast(
...
function useDriveUploadQueue() {
  ...
  const parentId = ((_a2 = activePage == null ? void 0 : activePage.folder) == null ? void 0 : _a2.id) || null;
...
function ShareableLinkPageFilePreview() {
  ...
  if (!(link == null ? void 0 : link.entry))
    return null;
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-screen bg-alt", children: [
    /* @__PURE__ */ jsx(ShareableLinkNavbar, {}),
    /* @__PURE__ */ jsx(AdHost, { slot: "file-preview", className: "mt-24" }),
    /* @__PURE__ */ jsx(
...
function ShareableLinkPage() {
  ...
  let content;
  if (status === "loading") {
    content = /* @__PURE__ */ jsx("div", { className: "flex-auto flex items-center justify-center h-screen", children: /* @__PURE__ */ jsx(
      ProgressCircle,
      {
...
function useCreateWorkspace(form) {
  return useMutation((props) => createWorkspace(props), {
    onSuccess: () => {
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          type: "submit",
          form: formId,
          disabled: createWorkspace2.isLoading,
...
function useWorkspaceWithMembers(workspaceId) {
  return useQuery(
    WorkspaceQueryKeys.workspaceWithMembers(workspaceId),
...
function useInviteMembers() {
  return useMutation((props) => InviteMembers(props), {
    onSuccess: (response, props) => {
...
function useResendInvite() {
  return useMutation((props) => ResendInvite(props), {
    onSuccess: () => {
      toast("Invite sent");
    },
    onError: (err) => showHttpErrorToast(err)
...
function useChangeRole() {
  return useMutation((props) => ChangeRole(props), {
    onSuccess: (response, props) => {
...
function useRemoveMember() {
  ...
  const { user } = useAuth();
  return useMutation((props) => removeMember(props), {
    onSuccess: (response, props) => {
      queryClient.invalidateQueries(WorkspaceQueryKeys.fetchUserWorkspaces);
      queryClient.invalidateQueries(
        WorkspaceQueryKeys.workspaceWithMembers(props.workspaceId)
...
function LeaveWorkspaceConfirmation() {
  return /* @__PURE__ */ jsx(
    ConfirmationDialog,
    {
      isDanger: true,
      ...
      body: /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "font-semibold mt-8", children: /* @__PURE__ */ jsx(Trans, { message: "All resources you've created in the workspace will be transferred to workspace owner." }) })
      ] }),
      ...
      children: [
        /* @__PURE__ */ jsx(
          IconButton,
          {
            ...
            disabled: removeMember2.isLoading,
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          type: "submit",
          form: formId,
          disabled: updateWorkspace2.isLoading,
...
function WorkspaceSelector({
  ...
  const { workspaceId, setWorkspaceId } = useActiveWorkspaceId();
  const activeWorkspace = data == null ? void 0 : data.find((w) => w.id === workspaceId);
  ...
  if (!activeWorkspace || !hasPermission("workspaces.create"))
    return null;
  const defaultTrigger = /* @__PURE__ */ jsxs(
    ButtonBase,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("span", { className: "block flex-auto mr-auto text-left overflow-hidden", children: [
          /* @__PURE__ */ jsx("span", { className: "block text-sm text-main font-medium overflow-hidden overflow-ellipsis", children: activeWorkspace.default ? /* @__PURE__ */ jsx(Trans, { message: activeWorkspace.name }) : activeWorkspace.name }),
          /* @__PURE__ */ jsx("span", { className: "block text-muted text-xs", children: activeWorkspace.default ? /* @__PURE__ */ jsx(Trans, { message: "Personal workspace" }) : /* @__PURE__ */ jsx(
            Trans,
            {
        ...
        /* @__PURE__ */ jsx(UnfoldMoreIcon, { className: "icon-md shrink-0" })
      ]
    }
  );
      ...
      DialogTrigger,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Dialog, { size: "min-w-320", children: /* @__PURE__ */ jsxs(DialogBody, { padding: "p-10", children: [
            /* @__PURE__ */ jsx("div", { className: "mb-16 pb-10 border-b", children: data.map((workspace) => /* @__PURE__ */ jsx(
              WorkspaceItem,
              {
                workspace,
                setDialog,
            ...
            /* @__PURE__ */ jsx("div", { className: "text-center mb-4 px-4", children: /* @__PURE__ */ jsx(
              Button,
              {
                onClick: (e) => {
                  e.preventDefault();
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-auto", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "text-muted text-sm", children: workspace.default ? /* @__PURE__ */ jsx(Trans, { message: "Personal workspace" }) : /* @__PURE__ */ jsx(
            Trans,
            {
              message: ":count members",
...
function DialogContainer({ dialog, setDialog, onChange }) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      type: "modal",
      isOpen: !!(dialog == null ? void 0 : dialog.name),
      onClose: (value) => {
        if ((dialog == null ? void 0 : dialog.name) === "deleteWorkspace" && value) {
          deleteWorkspace2.mutate({ id: dialog.workspace.id });
        }
        if ((dialog == null ? void 0 : dialog.name) === "leaveWorkspace" && value && (user == null ? void 0 : user.id)) {
          removeMember2.mutate({
        ...
        if ((dialog == null ? void 0 : dialog.name) === "newWorkspace" && value) {
      ...
      children: [
        (dialog == null ? void 0 : dialog.name) === "newWorkspace" && /* @__PURE__ */ jsx(NewWorkspaceDialog, {}),
        (dialog == null ? void 0 : dialog.name) === "updateWorkspace" && /* @__PURE__ */ jsx(RenameWorkspaceDialog, { workspace: dialog.workspace }),
        (dialog == null ? void 0 : dialog.name) === "workspaceMembers" && /* @__PURE__ */ jsx(WorkspaceMembersDialog, { workspace: dialog.workspace }),
        (dialog == null ? void 0 : dialog.name) === "deleteWorkspace" && /* @__PURE__ */ jsx(DeleteWorkspaceConfirmation, { workspace: dialog.workspace }),
        (dialog == null ? void 0 : dialog.name) === "leaveWorkspace" && /* @__PURE__ */ jsx(LeaveWorkspaceConfirmation, {})
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxs(
    MenuTrigger,
    {
      onItemSelected: (value) => {
        setSelectorIsOpen(false);
        setDialog({ name: value, workspace });
      },
      children: [
        /* @__PURE__ */ jsx(
          Button,
...
function Sidebar({ className }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-auto", children: [
          /* @__PURE__ */ jsx(CreateNewButton, { className: "text-center px-12 pt-28" }),
          /* @__PURE__ */ jsx(SidebarMenu, {}),
          /* @__PURE__ */ jsx(StorageMeter, {}),
          billing.enable && /* @__PURE__ */ jsx("div", { className: "pl-60 mt-14", children: /* @__PURE__ */ jsx(
            Button,
            {
              elementType: Link,
...
function getAllEntries() {
  const caches = queryClient.getQueriesData(DriveQueryKeys.fetchEntries());
...
function SearchFilterList() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-10 mb-30 px-10 md:px-26", children: [
      ...
      "form",
      {
        ...
        children: /* @__PURE__ */ jsx(
          TextField,
          {
            autoFocus: true,
            className: "mb-20",
            startAdornment: /* @__PURE__ */ jsx(IconButton, { type: "submit", radius: "rounded", children: /* @__PURE__ */ jsx(SearchIcon, {}) }),
...
function FileView({ className }) {
  ...
  const handleKeybinds = (e) => {
    ...
    if (e.key === "Delete") {
      e.preventDefault();
      e.stopPropagation();
      if (driveState().selectedEntries.size && !deleteEntries2.isLoading) {
        if (activePage === TrashPage) {
          driveState().setActiveActionDialog(
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col relative pt-10 min-h-full", children: [
        isMobileMode ? /* @__PURE__ */ jsx(PageBreadcrumbs, { className: "px-14 mb-10" }) : /* @__PURE__ */ jsx(Toolbar, {}),
        /* @__PURE__ */ jsx(SearchFilterList, {}),
        /* @__PURE__ */ jsxs("div", { className: "px-18 md:px-24 pb-18 flex-auto relative", children: [
...
function Toolbar() {
  const activePage = useDriveStore((s) => s.activePage);
  return /* @__PURE__ */ jsxs("div", { className: "px-10 md:px-18 my-10 flex items-center gap-40 justify-between text-muted min-h-42", children: [
...
function useSyncEntryTags() {
  return useMutation((props) => createComment(props), {
    onSuccess: () => {
      invalidateEntryQueries();
    },
...
function useRenameEntry(form) {
  return useMutation((payload) => renameEntry(payload), {
    onSuccess: (r, p) => {
      invalidateEntryQueries();
      toast(
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          variant: "flat",
          color: "primary",
          disabled: renameEntry2.isLoading || !form.formState.isDirty,
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          variant: "flat",
          color: "primary",
          disabled: createFolder2.isLoading,
          children: /* @__PURE__ */ jsx(Trans, { message: "Create" })
        }
      )
    ] })
...
function useShareEntry() {
  return useMutation((payload) => shareEntry(payload), {
    onSuccess: () => {
      invalidateEntryQueries();
    },
    onError: (err) => {
...
function useChangePermission() {
  return useMutation(
    (payload) => changePermission(payload),
    {
      onSuccess: () => {
        invalidateEntryQueries();
...
function useDeleteShareableLink() {
  return useMutation(({ entryId }) => deleteShareableLink({ entryId }), {
...
function ShareableLinkPanel({
  ...
  const isLoading = query.isLoading || createLink.isLoading || deleteLink.isLoading;
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { className: "mb-10", children: /* @__PURE__ */ jsx(Trans, { message: "Share link" }) }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-14 justify-between pb-4 px-2", children: [
      /* @__PURE__ */ jsx(
        Switch,
        {
          checked: linkExists,
...
function useUpdateShareableLink(form) {
  return useMutation(
    (payload) => updateShareableLink(payload),
    {
      onSuccess: (data, { entryId }) => {
        queryClient.setQueryData(
          DriveQueryKeys.fetchEntryShareableLink(entryId),
...
function LinkOption({ children, showBorder = true }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: clsx(showBorder && "border-b mb-20 pb-20"), children: [
    /* @__PURE__ */ jsx("div", { className: "text-sm font-medium mb-8", children: title }),
    content
  ] });
}
function ShareDialog({
  ...
  const {
    ...
    () => {
      return apiClient.get(`drive/file-entries/${initialEntry.id}/model`).then((response) => response.data);
    },
    {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(DialogBody, { className: "relative", children: /* @__PURE__ */ jsxs(
      m.div,
      {
        ...
        transition: { duration: 0.1 },
        children: [
          /* @__PURE__ */ jsx(SharePanel, { className: "border-b pb-30 mb-30", entry }),
          /* @__PURE__ */ jsx(
            ShareableLinkPanel,
            {
              setActivePanel,
...
function MoveEntriesDialogBreadcrumbs({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center border-b pb-10 gap-6", children: [
    /* @__PURE__ */ jsx(
      IconButton,
      {
        className: "flex-shrink-0",
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            variant: "flat",
            color: "primary",
            disabled: !canMoveEntriesInto(entries, selectedFolder) || moveEntries2.isLoading,
            onClick: () => {
              moveEntries2.mutate(
                {
...
function DeleteEntriesForeverDialog({
  ...
  return /* @__PURE__ */ jsx(
    ConfirmationDialog,
    {
      ...
      isLoading: deleteEntries2.isLoading,
      onConfirm: () => {
        deleteEntries2.mutate(
          {
            entryIds: entries.map((e) => e.id),
...
function BlockTrashFolderViewDialog({
  ...
  return /* @__PURE__ */ jsx(
    ConfirmationDialog,
    {
      ...
      isLoading: restoreEntries2.isLoading,
      onConfirm: () => {
        restoreEntries2.mutate(
          {
            entryIds: entries.map((e) => e.id)
...
function DriveLayout() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    (activePage == null ? void 0 : activePage.label) && /* @__PURE__ */ jsx(StaticPageTitle, { children: activePage.label }),
...
function FloatingActionList() {
  ...
  if (!entriesSelected)
    return null;
  return /* @__PURE__ */ jsxs("div", { className: "fixed bg-primary w-full h-54 text-on-primary shadow-xl z-10 rounded top-0 right-0 flex items-center justify-center gap-10 px-6", children: [
    /* @__PURE__ */ jsx(
      IconButton,
      {
        onClick: () => {
...
//# sourceMappingURL=drive-routes-8c734873.mjs.map
