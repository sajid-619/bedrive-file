...
import { e as createSvgIcon, bh as AccountCircleIcon, bi as AddAPhotoIcon, bj as ApiIcon, aO as ArrowDropDownIcon, bk as CheckBoxOutlineBlankIcon, aW as CheckCircleIcon, E as CheckIcon, G as CloseIcon, bl as ComputerIcon, bm as DangerousIcon, bn as DarkModeIcon, bo as DevicesIcon, V as DoneAllIcon, aV as ErrorIcon, bp as ErrorOutlineIcon, aN as ExitToAppIcon, bq as FileDownloadDoneIcon, br as ForumIcon, bs as GroupAddIcon, K as KeyboardArrowDownIcon, bt as LanguageIcon, bu as LightModeIcon, bv as LightbulbIcon, bw as LockIcon, bx as LoginIcon, by as MenuIcon, bz as NotificationsIcon, bA as PaymentsIcon, bB as PeopleIcon, bC as PersonIcon, bD as PhonelinkLockIcon, n as SearchIcon, bE as SmartphoneIcon, bF as TabletIcon, as as WarningIcon, bG as useCollator, Q as ButtonBase, T as Trans, bH as elementToTree } from "../server-entry.mjs";
import { j as AddIcon, Q as ArrowBackIcon, a9 as ArrowDownwardIcon, aa as ArrowRightAltIcon, ab as ChevronLeftIcon, a5 as DateRangeIcon, x as DeleteIcon, l as FileDownloadIcon, K as KeyboardArrowLeftIcon, f as KeyboardArrowRightIcon, L as LinkIcon, ac as MenuOpenIcon, M as MoreVertIcon, P as UnfoldMoreIcon } from "./UnfoldMore-a9683c4c.mjs";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    matchedEntries.map(([name, Icon]) => /* @__PURE__ */ jsxs(
      ButtonBase,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(Icon, { className: "icon-lg block text-muted" }),
          /* @__PURE__ */ jsx("span", { className: "block mt-16 text-xs whitespace-normal capitalize", children: name })
        ]
      },
      name
    ))
...
//# sourceMappingURL=icon-list-61fe3c85.mjs.map
